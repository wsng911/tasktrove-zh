...
import { ChineseDateExtractor } from "./ChineseDateExtractor";
...
const CHINESE_EXTRACTORS = [
  PriorityExtractor,
  ProjectExtractor,
  LabelExtractor,
  ChineseDateExtractor, // Use Chinese date extractor instead of default
  TimeExtractor,
  RecurringExtractor,
  EstimationExtractor,
];
...
export class ChineseLocaleConfig implements LocaleConfig {
  readonly locale = "zh";
  ...
  getExtractors(): Extractor[] {
    let extractors = CHINESE_EXTRACTORS;
